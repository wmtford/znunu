...
def writeEffHists():
    ...
    # Tribeni's April 30, 2019 email:
    EB['avg'] = [0.9585237282663334, 0.9655377672926667, 0.9573121921196667, 0.9780058351790001]
    EB['avgErr'] = [0.01503588162766667, 0.012745221590333311, 0.030069619554666693, 0.015233362697000041]
    EE['avg'] = [0.9146774582016667, 0.935474352252, 0.9529644423696667, 0.9139508701260001]
    EE['avgErr'] = [0.03900177181333331, 0.04516318903700001, 0.03375556950166669, 0.07415651228700004]
    # Tribeni's April 26, 2019 email:
    ...
    # Tribeni's April 30, 2019 email:
    EB['avg'] = [0.9342100368063333, 0.9314974434336666, 0.9465496181459999, 0.9740882583786666]
    EB['avgErr'] = [0.01670800533666672, 0.014039765814666594, 0.012519827723999954, 0.005997829767666607]
    EE['avg'] = [0.9474012509276667, 0.9440603120246666, 0.932038118126, 0.9184040365386666]
    EE['avgErr'] = [0.020318385815666695, 0.019925140345333436, 0.02994515393999997, 0.03723930046666668]
    # Tribeni's April 26, 2019 email:
    EB_ldp['avg'] = [0.867368480889, 0.8540455754413333, 0.8483960770856666, 0.9045874008393334]
    EB_ldp['avgErr'] = [0.056006291401, 0.06455268990933327, 0.05125898994866651, 0.03271043206433344]
    EE_ldp['avg'] = [0.8886791026499999, 0.897029311727, 0.8028611527306667, 0.7788664830493334]
    EE_ldp['avgErr']  = [0.045075913452000016, 0.02533815284499996, 0.05005716822833328, 0.05555676379266661]
    for i in range(0,4):
    ...
    # Tribeni's April 26, 2019 email:
    EB_ldp['avg'] = [0.8675806532079999, 0.858558924094, 0.8755681166220001, 0.9187331436863334]
    EB_ldp['avgErr'] = [0.0605641676619999, 0.04332221426000005, 0.054710200390000074, 0.035716791730333375]
    EE_ldp['avg'] = [0.9055162794053334, 0.876280041638, 0.809691137856, 0.7472074954379999]
    EE_ldp['avgErr'] = [0.026188641671666568, 0.032801027306999964, 0.05357446361700002, 0.07041979225200012]
    for i in range(0,4):
