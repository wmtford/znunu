{
  ...
  const char* gJets16 = "../datFiles/gJets_2016v16_noPU_DRRun2wt";
  const char* gJets17 = "../datFiles/gJets_2017v16_DRRun2wt";
  const char* gJets18AB = "../datFiles/gJets_2018v16_DRRun2wt";
  const char* gJets18CD = "../datFiles/gJets_2018HEMv16_DRRun2wt";
  const char* DR = "../datFiles/DR_Run2v16_HT17wt_ZptWt_noPU_DRRun2wt";
  ...
  const char* DYRun2 = "../datFiles/DY_Run2v16";
  ...
  const char* zJetsRun2 = "../plots/histograms/ZinvMCttzMC174bin_Run2v16_HT17_ZptWt_noPU.root";
  ...
  if (do2016) {
    ...
    RA2bin_inputs_Zinv(Signal, gJetsInputs, DR, DY18AB, zJets18AB, 21.1/59.2, true);
  }
  else if (do2018CD) {
    std::vector< std::pair<TString, float> > gJetsInputs = {std::make_pair(gJets18CD, 38.3)};
    RA2bin_inputs_Zinv(Signal, gJetsInputs, DR, DY18CD, zJets18CD, 38.3/59.2, true);
  }
  else if (do2018) {
    ...
    // RA2bin_inputs_Zinv(Signal, gJetsInputs, DR, DY18, zJets18, 59.2/59.2, true);
  }
  else if (doRun2) {
    std::vector< std::pair<TString, float> > gJetsInputs = {
    ...
    RA2bin_inputs_Zinv(Signal, gJetsInputs, DR, DYRun2, zJetsRun2, 136.8/136.8, true);
  }
