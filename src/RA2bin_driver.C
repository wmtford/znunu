{
  ...
  const char* gJets16 = "../datFiles/gJets_2016v17_DRr2wt";
  const char* gJets17 = "../datFiles/gJets_2017v17_DRr2wt";
  const char* gJets18AB = "../datFiles/gJets_2018ABv17_DRr2wt";
  const char* gJets18CD = "../datFiles/gJets_2018CDv17_DRr2wt";
  const char* DR = "../datFiles/DR_Run2v17_DRr2wt";
  ...
  const char* DYRun2 = "../datFiles/DY_Run2v17";
  ...
  const char* zJetsRun2 = "../plots/histograms/ZinvMCttzMC174bin_Run2v17.root";
