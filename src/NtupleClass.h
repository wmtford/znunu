...
// Wed Oct 14 11:56:59 2020 by ROOT version 6.14/09
// from TTree PreSelection/PreSelection
// from TTree tree/all observables, GJet_CleanVars
// found on file: root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18/Run2017B-31Mar2018-v1.MET_0_RA2AnalysisTree.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<string>  *TriggerNames;  // for backward compatibility
   ...
   TBranch        *b_TriggerNames;   //!  for backward compatibility
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      return;
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18/Run2017B-31Mar2018-v1.MET_0_RA2AnalysisTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18/Run2017B-31Mar2018-v1.MET_0_RA2AnalysisTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV18/Run2017B-31Mar2018-v1.MET_0_RA2AnalysisTree.root:/TreeMaker2");
...
void NtupleClass::Init(TTree *tree)
{
   ...
   TriggerNames = 0;  // for backward compatibility
   TriggerPass = 0;
   TriggerPrescales = 0;
   TriggerVersion = 0;
   ZCandidates = 0;
